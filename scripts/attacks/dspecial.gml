...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_LENGTH, 12 - has_rune("E") * 6);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_TYPE, 7 - has_rune("O") * 7);
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_TYPE, 7 - has_rune("O") * 7);
